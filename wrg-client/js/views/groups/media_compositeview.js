define([
    'marionette',
    'text!templates/groups/media.html',
    'views/groups/media_itemview',
    'collections/groups/media',
    'views/groups/edit/media_form_view'
    ...
    var MediaCollectionView = Marionette.CompositeView.extend({
        ...
        showPicture: function (direction, onChangeValue) {
            ...
            if (direction === "firstmedia") {
                ...
                this.groupMediaRenderer(isVideo, imageSrc, tempObject, originalPosition, modelSize);
            }
            ...
            if (direction === "right") {
                if (originalPosition === modelSize - 1) {
                    ...
                    this.groupMediaRenderer(isVideo, imageSrc, tempObject, 0, modelSize);
                } else {
                    originalPosition++;
        ...
        groupMediaRenderer: function (isVideo, imageSrc, tempObject, originalPosition, modelSize) {
            $('#mediaCaption').html('');

            if (isVideo === 'video') {
                var shortUrl = imageSrc.split("watch?v="),
                    embeddedUrl = "//www.youtube.com/" + 'embed/' + shortUrl[1];
                $('#bigPicture').html('');
                var myImage = $('<iframe/>', {
                    width: "300",
                    height: "300",
                ...
                $('#groupMediaCaption').html(tempObject.video_caption);
                ...
                $('#groupMediaCaption').html(tempObject.photo_caption);
                originalPosition++;
                $('#mediaCounter').html(originalPosition + " of " + modelSize);
            }
        },
        ...
        mediaCounter: function (originalPosition, modelSize, deleted) {
            if (deleted) {    //in delete case, ensure we point to the last media in collection
                ...
                this.groupMediaRenderer(myModel.type, myModel.media_url, myModel, originalPosition, modelSize);
