define([
    'marionette',
    'text!templates/college/edit/media_form.html',
    ...
    var MediaFormView = Marionette.Layout.extend({
        ...
        addVideo: function () {
            if ($('#videoUrl').val() === '') {
                ...
                var college_id = this.model.get('college_id');
        ...
        onShow: function () {
            this.afterRender();
            var collegeId = this.model.get('college_id');
            ...
            $('form').ajaxForm({
                ...
                complete: function (xhr) {
                    ...
                    if (numberOfPhotos > config.media.maxNumberOfPhotoFiles - 1) {
                        ...
                        that.model.set('college_id', collegeId);
                    }
                }
            });
        },
        ...
        mediaHtml: function (index, video_url, photo_url, type) {
            ...
            if (type === 'video') {
                ...
                this.model.set('college_id', college_id);
