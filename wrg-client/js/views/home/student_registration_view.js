define([
    'marionette',
    'text!templates/home/student_registration.html',
...
], function (Marionette, Template, RegistrationModel, ErrorMessageView, Notificator, Login, validationRules, SearchAsYouType, ConversionUtils) {
    "use strict";

    var StudentRegistrationView = Marionette.Layout.extend({
        template: Template,
        ...
        events: {
            ...
            'focus #graduation-year': function () {
                ConversionUtils.insertYearsFromNow('graduation-year', 'Graduation Year');
            },
        ...
        save: function (e) {
            ...
            this.model.set({
                ...
                'school': this.$('#searchSchools').val(),
                'school_id': schoolId,
                'major': this.$('#major').val(),
                'graduation_month': this.$('#graduation-month').val(),
            ...
            this.model.save(null, {
                ...
                error: _.bind(function (model, response) {
                    ...
                    if (response.responseJSON.message) {
                        ...
                        if (response.responseJSON.user.detail) {
                            message = response.responseJSON.user.detail;
                        }
                        if (response.responseJSON.user.detail) {
                            message = response.responseJSON.alumni.ValidationError;
                        }
                    }
