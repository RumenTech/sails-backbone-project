define([
    ...
    var IndexView = Marionette.Layout.extend({
        ...
        onLoaded: function () {
            ...
            this.listenTo(this.experiencePoints.currentView, 'showModal', this.showModal, this);
            this.listenTo(this.experiencePoints.currentView, 'showExpModal', this.showModal, this);
        ...
        update_points_new: function (experiences) {
            ...
            if (experiences.model) {
                ...
                this.experiencePoints.show(new ExperiencePointsView({
                    reqres: this.reqres,
                    data: experiences.model.collection
                }));
                this.listenTo(this.experiencePoints.currentView, 'showModal', this.showModal, this);
                this.listenTo(this.experiencePoints.currentView, 'showExpModal', this.showModal, this);
            }
