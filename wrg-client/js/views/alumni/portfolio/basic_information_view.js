define([
    'marionette',
    'text!templates/alumni/portfolio/basic_information.html',
    'views/alumni/portfolio/edit/basic_information_form_view',
    ...
    var BasicInformationView = Marionette.ItemView.extend({
        ...
        serializeData: function () {
            ...
            var monthName = this.reqres.request('format:month', this.model.get('graduation_month') - 1);
