Hull.component({
    ...
    //****************IMPORTANT*********************************************
    //After one year passes, this will have to be changed to Game application
    //for thesimple reason as Facebook is no longer supporting me/friends REST call
    //When making new account on facebook, make sure you mark the application as a game!!!!!!!

    //For normal mode use me/friends
    //for game mode application use me/invitable_friends me/invitable_friends
    ...
    initialize: function () {
        ...
        this.buildParams = this.buildParamsFor[this.method] || function (params) {
            return params;
        };
    },
    ...
    filterFriends: function (friends) {
        ...
        return _.sortBy(ret, function (f) {
            return f.name
        });
    }
});