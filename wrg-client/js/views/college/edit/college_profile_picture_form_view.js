define([
    'marionette',
    'text!templates/college/edit/college_profile_picture_form.html',
    ...
    var CollegeProfilePictureFormView = Marionette.ItemView.extend({
        template: Template,
            ...
            $('form').ajaxForm({
                beforeSend: function () {
                    ...
                    if (!ConversionUtils.isBrowserIeLow()) {
                        ...
                        var validationResult = imageValidator.validate($("#file-image")[0].files, config.imageSize);
    ...
    return CollegeProfilePictureFormView;
});