define([
    'marionette',
    'text!templates/pointoflight/poi_index.html',
    ...
    'views/pointoflight/pointoflight_compositeview',
    ...
    ModalRegion,
    Company,
    ChallengesCompositeView,
    FilterFormView,
    ChallengesCollection,
    SponsorsView,
    PointsOfLightCompositeView,
    CSE) {
...
*/
            ...
            CSE.getPointOfLightJobs(query, function(data){
                that.moocs = new PointsOfLightCompositeView(data.items, that.options);
                that.results.reset();
                that.results.show(new PointsOfLightCompositeView({
                    reqres:that.reqres,
