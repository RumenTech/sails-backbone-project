...
module.exports.routes = {
  ...
  // (This would also work if you had a file at: `/views/home.ejs`)
   /* '/': {
    ...
    '/uploads/fullsize/:file': {
        controller: 'imgUploadController',
        action: 'returnBinaryImage'
    },
  ...
  */
   ...
   'put /company/me': 'CompanyController.update',
   'put /college/me': 'CollegeController.update',
   'post /login/callback': 'AuthController.loginCallback'
