define([
    'marionette',
    'text!templates/company/add_event_form.html',
    'lib/backbone.modelbinder',
    'models/company/company_event',
    'views/error_message_view',
    'utils/eventValidation',
    'lib/jqueryui'
], function (Marionette, Template, ModelBinder, CompanyEvent, ErrorMessageView, eventValidation) {
    "use strict";
    ...
    var AddEventView = Marionette.Layout.extend({
        ...
        initialize: function (params) {
            ...
            if (!this.model) {
                this.model = new CompanyEvent(params.data, params);
